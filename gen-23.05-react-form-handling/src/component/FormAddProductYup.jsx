        ...
        <div className="border-2 p-4">
            <form onSubmit={handleSubmit(submitForm)}>
                ...
                <div className="mb-6">
                    ...
                    <input type="text" className=" border-solid border-2" name="nama" {...register('nama')}></input>
                    <p>{errors.nama?.message}</p>
                </div>
                <div className="mb-6">
                    <label className="block" htmlFor="merk">Merk</label>
                    <input type="text" className=" border-solid border-2" name="merk" {...register('merk')}></input>
                    <p>{errors.merk?.message}</p>
                </div> 
                <div className="mb-6">
                    <label className="block" htmlFor="harga">Harga</label>
                    <input type="text" className=" border-solid border-2" name="harga" {...register('harga')}></input>
                    <p>{errors.harga?.message}</p>
                </div> 
                <div className="mb-6">
                    <label className="block" htmlFor="deskripsi">Deskripsi</label>
                    <input type="text" className=" border-solid border-2" name="deskripsi" {...register('deskripsi')}></input>
