...
function PreviewImage(props) {
    ...
    function MiniImg(props) {
        ...
        return (
            <img
                {...props}
                onClick={() => setSource(handleclick)}
                className=' px-2 w-26 h-26 rounded-md cursor-pointer border-solid border-4 hover:opacity-50 '
            />
        );
    }
    ...
    return (
        <div className='flex flex-col justify-between w-auto gap-4 md:pr-7 mb-8'>
            <img
                src={source}
                className='w-auto h-96 px-4 aspect-square bg-contain rounded-xl border-solid border-8 '
            />
